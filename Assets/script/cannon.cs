...
public class cannon : MonoBehaviour {
	...
	void Update () {
        ...
        if (currentTime <= 0f)
        {
            ...
            bullet = Instantiate(Resources.Load("Prefabs/bullet4cannon"), this.transform.position - new Vector3(0, size, 0), Quaternion.identity) as GameObject;//this.GetComponent<Collider2D>().bounds.size.x / 2
